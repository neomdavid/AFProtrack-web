  ...
  return (
    <div className="flex flex-col gap-8 pb-6">
      ...
      <div
        ...
        className="flex max-h-150 flex-col items-center bg-white  border-3 shadow-sm  border-gray-200  lg:p-5 rounded-sm"
      >
        <p className="text-xl mb-[-5px] font-semibold w-full text-left mb-5">
