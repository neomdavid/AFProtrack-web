...
const ProgramsTab = () => {
  return (
    <div className="flex flex-col gap-8 pb-6">
      ...
      <div
        style={{ width: "calc(100vw - 14.5rem)" }} // 14.5rem = w-58
        className="\flex flex-col bg-white  border-3 shadow-sm  border-gray-200 p-3 rounded-sm"
      >
        <p className="text-xl font-semibold">Training Completion Overview</p>
        <MixedChart />
      </div>
    </div>
  );
