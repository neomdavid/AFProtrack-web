  ...
  return (
    <div className="flex flex-col gap-8 pb-6">
      ...
      <section className="flex gap-8">
        <div className="flex flex-1 flex-col gap-2 bg-white p-4 border-3 shadow-sm border-gray-200 rounded-sm">
          <p className="text-xl font-bold mb-2">Performance Metrics</p>

          <div className="flex flex-col gap-1">
            <div className="flex justify-between mb-1">
              <p className="font-semibold">Program Completion Rate</p>
              <p>89%</p>
            </div>
