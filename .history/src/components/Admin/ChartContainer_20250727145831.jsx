...
const ChartContainer = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center max-h-200 bg-white border-3 shadow-sm border-gray-200 p-2 lg:pt-5 lg:px-5 rounded-sm"
    >
      ...
      {/* Slider */}
      <div style={{ width: "calc(100vw - 340px)" }} className="bg-red-100  ">
