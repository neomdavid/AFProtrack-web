...
const ChartContainer = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col items-center max-h-200 bg-white border-3 shadow-sm border-none border-r-gray-200 lg:p-5 rounded-sm"
    >
      ...
      {/* Slider */}
      <div className="bg-white shadow-sm p-3 w-full ">
