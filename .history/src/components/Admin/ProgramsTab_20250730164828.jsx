        ...
        <table className="table ">
          ...
          <tbody>
            <tr className="text-center">
              ...
              <td>MAJ. Rodriguez</td>
              <td>48/50</td>
              <td className="flex justify-center items-center bg-red-100">
              ...
              <td>
                {" "}
                <button
                  className="w-full h bg-primary text-[12px] text-white bg-red-100 py-1.5 rounded-sm hover:bg-primary/80 hover:cursor-pointer transition-all duration-300"
