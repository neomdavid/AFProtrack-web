        ...
        <table className="table ">
          ...
          <tbody>
            <tr className="text-center">
              ...
              <td>MAJ. Rodriguez</td>
              <td>48/50</td>
              <td className="flex justify-center items-center bg-red-100 h-full">
                <div className="bg-info text-info-content border border-info-content px-3 text-[12px] ">
                  Ongoing
                </div>
              </td>
              <td className="bg-red-100 h-full overflow-hidden">
                {" "}
                <button
                  className="w-full bg-primary text-[12px] text-white  rounded-sm hover:bg-primary/80 hover:cursor-pointer transition-all duration-300"
