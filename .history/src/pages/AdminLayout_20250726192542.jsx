      ...
      <div className="ml-58 p-8 relative bg-base-400">
        ...
        <section className="fixed flex items-center gap-1.5 right-12 top-7">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-md flex font-light">Surname, FN</p>
            <div className="flex items-center gap-0.5 text-xs text-success bg-base-success px-2 py-1 ml-[-3px]  border border-success rounded-2xl">
              <ShieldIcon size={15} weight="bold" />
              <p>Admin Access</p>
            </div>
          </div>
        </section>
