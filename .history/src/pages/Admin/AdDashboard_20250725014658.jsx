  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-4">
        <div className="flex  items-start bg-white rounded-sm border shadow-sm gap-3 border-gray-300 p-4 py-10 ">
          <div className="bg-[#557CB7] p-2 rounded-3xl">
            <UsersIcon size={23} weight="fill" color="white" />
          </div>
          <div className="flex flex-col gap-1">
            <h2 className="font-bold text-md text-black/65">Total Personnel</h2>
            <p className="text-2xl font-semibold">3,000</p>
            <p className="text-sm">Active military personnel</p>
