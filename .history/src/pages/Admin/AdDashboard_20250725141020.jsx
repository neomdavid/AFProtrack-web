      ...
      <div className="flex w-[50%]">
        <button
          className={`flex-1 flex justify-center border-3 shadow-sm rounded-md bg-white py-2 px-2  border-gray-200 ${
            activeTab === "programs"
              ? "border-3.5 border-primary text-primary z-4 font-bold"
        ...
        <button
          className={`flex-1 flex justify-center border-3 shadow-sm rounded-md bg-white py-2 px-2  border-gray-200 ml-[-1px] ${
            !activeTab === "programs"
