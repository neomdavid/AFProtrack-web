    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-wrap mb-13">
        <button
          ...
          className={` w-75 flex justify-center border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200 ${
            activeTab === "programs"
        ...
        <button
          ...
          className={` w-75 flex justify-center border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200 ml-[-2px] ${
            activeTab !== "programs"
