  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex w-[50%]">
        <button className="flex-1 flex justify-center border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200">
          Training Programs
        </button>
        <button className="flex-1 flex justify-center border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200 ml-[-1px]">
          Training Completion
        </button>
      </div>
    </div>
