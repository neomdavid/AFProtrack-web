    ...
    <div className="flex flex-col">
      ...
      <div className="flex w-[50%] mb-13">
        <button
          ...
          className={`flex-1 flex justify-center font-semibold border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200 ${
            activeTab === "programs"
        ...
        <button
          ...
          className={`flex-1 flex justify-center font-semibold border-3 shadow-sm rounded-sm bg-white py-2 px-2  border-gray-200 ml-[-2px] ${
            activeTab !== "programs"
