...
const AccountRequestModal = ({ open, onClose, request, onStatusUpdate }) => {
  ...
  const getStatusBadge = (status) => {
    ...
    return <span className={statusClasses[status] || 'badge badge-neutral badge-lg'}>{status}</span>;
  };
        ...
        <div className="flex-1 overflow-y-auto pr-2 min-h-0">
          <div className="space-y-4 pb-4">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <h4 className="font-semibold mb-3 text-base">Request Information</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Request ID</span>
                  </label>
                ...
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Request Date</span>
                  </label>
                  <div className="text-sm font-medium text-gray-900 bg-white px-3 py-2 rounded border border-gray-200">
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <h4 className="font-semibold mb-3 text-base">Personal Information</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Service ID</span>
                  </label>
                  <div className="text-sm font-medium text-gray-900 bg-white px-3 py-2 rounded border border-gray-200">
                    {request.serviceId}
                  </div>
            ...
            <div className="p-3 bg-gray-50 rounded-lg">
              <h4 className="font-semibold mb-3 text-base">Organizational Information</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="label py-1">
                ...
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Branch of Service</span>
                  </label>
                  <div className="text-sm font-medium text-gray-900 bg-white px-3 py-2 rounded border border-gray-200">
                ...
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Division</span>
                  </label>
                  <div className="text-sm font-medium text-gray-900 bg-white px-3 py-2 rounded border border-gray-200">
                    {request.division}
                  </div>
                ...
                <div>
                  <label className="label py-1">
                    <span className="label-text font-medium text-sm">Date Enlisted</span>
                  </label>
                  <div className="text-sm font-medium text-gray-900 bg-white px-3 py-2 rounded border border-gray-200">
            ...
            {request.status === 'Pending' && (
              <div className="p-3 flex flex-col">
                <h4 className="font-semibold mb-3 text-base">Review Decision</h4>
            ...
            {request.status === 'Declined' && (
              <div className="p-3">
                <div className="flex items-center gap-2 text-red-600">
                  <XCircleIcon size={20} />
                  <span className="font-medium">This request has been declined.</span>
                </div>
              </div>
            )}
          </div>
